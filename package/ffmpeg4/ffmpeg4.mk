...
#ifeq ($(BR2_PACKAGE_FFMPEG4_FFSERVER),y)
#FFMPEG4_CONF_OPTS += --enable-ffserver
#else
#FFMPEG4_CONF_OPTS += --disable-ffserver
#endif

ifeq ($(BR2_PACKAGE_FFMPEG4_AVRESAMPLE),y)
...
ifeq ($(BR2_PACKAGE_FFMPEG4_POSTPROC),y)
FFMPEG4_CONF_OPTS += --enable-postproc
else
FFMPEG4_CONF_OPTS += --disable-postproc
endif

ifeq ($(BR2_PACKAGE_FFMPEG4_SWSCALE),y)
FFMPEG4_CONF_OPTS += --enable-swscale
else
FFMPEG4_CONF_OPTS += --disable-swscale
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_FFMPEG4_ENCODERS)),all)
FFMPEG4_CONF_OPTS += --disable-encoders \
	$(foreach x,$(call qstrip,$(BR2_PACKAGE_FFMPEG4_ENCODERS)),--enable-encoder=$(x))
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_FFMPEG4_DECODERS)),all)
FFMPEG4_CONF_OPTS += --disable-decoders \
	$(foreach x,$(call qstrip,$(BR2_PACKAGE_FFMPEG4_DECODERS)),--enable-decoder=$(x))
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_FFMPEG4_MUXERS)),all)
FFMPEG4_CONF_OPTS += --disable-muxers \
	$(foreach x,$(call qstrip,$(BR2_PACKAGE_FFMPEG4_MUXERS)),--enable-muxer=$(x))
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_FFMPEG4_DEMUXERS)),all)
FFMPEG4_CONF_OPTS += --disable-demuxers \
	$(foreach x,$(call qstrip,$(BR2_PACKAGE_FFMPEG4_DEMUXERS)),--enable-demuxer=$(x))
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_FFMPEG4_PARSERS)),all)
FFMPEG4_CONF_OPTS += --disable-parsers \
	$(foreach x,$(call qstrip,$(BR2_PACKAGE_FFMPEG4_PARSERS)),--enable-parser=$(x))
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_FFMPEG4_BSFS)),all)
FFMPEG4_CONF_OPTS += --disable-bsfs \
	$(foreach x,$(call qstrip,$(BR2_PACKAGE_FFMPEG4_BSFS)),--enable-bsfs=$(x))
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_FFMPEG4_PROTOCOLS)),all)
FFMPEG4_CONF_OPTS += --disable-protocols \
	$(foreach x,$(call qstrip,$(BR2_PACKAGE_FFMPEG4_PROTOCOLS)),--enable-protocol=$(x))
endif

ifneq ($(call qstrip,$(BR2_PACKAGE_FFMPEG4_FILTERS)),all)
FFMPEG4_CONF_OPTS += --disable-filters \
	$(foreach x,$(call qstrip,$(BR2_PACKAGE_FFMPEG4_FILTERS)),--enable-filter=$(x))
endif

ifeq ($(BR2_PACKAGE_FFMPEG4_INDEVS),y)
...
ifeq ($(BR2_PACKAGE_FFMPEG4_OUTDEVS),y)
...
ifeq ($(BR2_PACKAGE_FDK_AAC)$(BR2_PACKAGE_FFMPEG4_NONFREE),yy)
...
ifeq ($(BR2_PACKAGE_FFMPEG4_GPL)$(BR2_PACKAGE_LIBCDIO_PARANOIA),yy)
...
ifeq ($(BR2_PACKAGE_FFMPEG4_GPL)x$(BR2_PACKAGE_FFMPEG4_NONFREE),yx)
...
ifeq ($(BR2_PACKAGE_FFMPEG4_GPL)$(BR2_PACKAGE_LIBEBUR128),yy)
...
FFMPEG4_CONF_OPTS += --enable-mmal --enable-omx --enable-omx-rpi \
...
FFMPEG4_CONF_OPTS += --enable-libwavpack
FFMPEG4_DEPENDENCIES += wavpack
else
FFMPEG4_CONF_OPTS += --disable-libwavpack
endif
...
ifeq ($(BR2_PACKAGE_X264)$(BR2_PACKAGE_FFMPEG4_GPL),yy)
...
ifeq ($(BR2_PACKAGE_X265)$(BR2_PACKAGE_FFMPEG4_GPL),yy)
...
FFMPEG4_CONF_OPTS += $(call qstrip,$(BR2_PACKAGE_FFMPEG4_EXTRACONF))
